<?php
	...
	if (function_exists('add_theme_support'))
	{
		...
		add_image_size('storefront', 770, 300, true);
	}
	...
	function business_manager_add_meta()
	{
		add_meta_box("business-meta", "Business Options",
			"business_manager_meta_options", "businesses", "normal" , "high");
	...
	function business_manager_meta_options(){
		...
		<div class="business-manager-extras">
			<?php
			...
			<div>
				<label>Zip:</label><input name="zip" value="<?php echo $zip; ?>" />
			</div>
		</div>
	<?php
	}
	...
	add_action('init', 'pibusiness_rewrite');
	function pibusiness_rewrite()
	{
		global $wp_rewrite;

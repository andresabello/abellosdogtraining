...
class QuoteForm extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        echo "<div class='textwidget'><div class='quote-form quote-form-$id' data-id='$id'><div is='quote-form'>{$title}{$instance['content']}</div></div>
              </div>";

...
class CurrencyConverter extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        echo "<div class='textwidget'><div class='currency-converter currency-converter-$id' data-id='$id'><div is='currency-converter'>{$title}{$instance['content']}</div></div>
              </div>";
